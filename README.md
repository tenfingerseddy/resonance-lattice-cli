...
For the full walkthrough - including profiling, comparison, MCP integration, assistant context files, and HTTP serving - see [Getting Started](https://resonance-lattice.com/docs/getting-started).
...
For full methodology and extended results, see `benchmarks/results/`.
...
- [Getting Started](https://resonance-lattice.com/docs/getting-started)
- [CLI Reference](docs/CLI.md)
- [Encoder Guide](docs/ENCODERS.md)
- [RQL Reference](docs/RQL_REFERENCE.md)
- [FAQ](https://resonance-lattice.com/docs/faq)
